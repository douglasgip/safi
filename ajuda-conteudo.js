...
window.SAFI_AJUDA = { telas: {
  ...
  lancamentos: {
    titulo: 'Lançamentos', versao: 1,
    resumo: 'Em <b>Lançamentos</b> você alimenta o DRE: informa mês a mês os valores de cada empresa, mantém a estrutura de contas e registra o Resumo Contábil.',
    passos: [
      { t: 'Escolha empresa, mês e ano', d: 'Nos filtros do topo da aba <b>Lançar DRE</b>. Só aparecem as empresas que você pode lançar.' },
      { t: 'Preencha os valores', d: 'A árvore mostra as contas por <b>classe → campo → subcampo</b>. Digite os valores do mês.' },
      { t: 'Ou importe uma planilha', d: '<b>Baixar modelo</b> gera a planilha no formato certo; depois <b>Importar planilha</b> e confira o resumo antes de confirmar.' },
      { t: 'Salve', d: 'Clique em <b>Salvar Lançamentos</b>. O DRE é atualizado sozinho e a alteração fica registrada na trilha de auditoria.' },
    ],
    dicas: ['Mês <b>Travado</b> no Fechamento aparece com aviso e não aceita edição — peça a quem fecha para destravar (fica registrado).', 'Mês <b>Aprovado</b> ainda aceita edição; só o Travado bloqueia.', 'A aba <b>Gerenciar Estrutura</b> permite criar/ordenar classes, campos e subcampos.', 'A aba <b>Resumo Contábil</b> guarda entrada, saída, despesa, estoque e alíquota do mês.'],
    naoFaz: ['Não substitui a contabilidade oficial.', 'Não aparece o que você não tem liberação para lançar.'],
    termos: [{ t: 'Classe / campo / subcampo', d: 'Hierarquia das contas do DRE (ex.: Custos Variáveis → Frete → Frete Pago).' }, { t: 'Travado', d: 'Mês fechado: bloqueado para edição no banco de dados.' }],
    quemVe: 'Quem tem a permissão Lançamentos, empresa por empresa.',
    dados: 'Digitados aqui ou importados por planilha; alimentam DRE, Resumo Contábil, Painel do Conselho e GerônIA.',
    tour: [
      { sel: '#tab-lancar', t: 'Três abas', d: '<b>Lançar DRE</b> (valores do mês), <b>Gerenciar Estrutura</b> (contas) e <b>Resumo Contábil</b>.' },
      { sel: '#entry-filters', t: 'Empresa, mês e ano', d: 'Escolha o que vai lançar. É aqui também que ficam <b>Baixar modelo</b> e <b>Importar planilha</b>.' },
      { sel: '#entry-tree', t: 'Árvore de contas', d: 'Preencha os valores do mês em cada conta. Se o mês estiver travado, aparece um aviso e os campos ficam bloqueados.' },
      { sel: '#btn-save-valores', t: 'Salvar', d: 'Grava os valores, atualiza o DRE e registra quem alterou o quê.' },
  ...
  fluxocaixa: {
    titulo: 'Fluxo de Caixa', versao: 1,
    resumo: 'Por enquanto o <b>Fluxo de Caixa</b> mostra as <b>Contas a Pagar</b> geradas pelos Pedidos: parcelas de pedidos que já chegaram e ainda não foram pagas.',
    passos: [
      { t: 'Veja o que vence', d: 'A lista traz empresa, fornecedor, parcela, valor e vencimento, das mais urgentes para as mais distantes.' },
      { t: 'Marque como paga', d: 'Ao pagar uma parcela, use o botão da coluna <b>Ação</b> — ela sai da lista e o pedido avança de status.' },
    ],
    dicas: ['A parcela só entra aqui depois que o pedido é marcado como <b>chegou</b> (conferido).', 'Parcelas com vencimento anterior a hoje estão <b>atrasadas</b>.'],
    naoFaz: ['A estrutura completa (ativos, passivos e movimentação) ainda está sendo definida com o Aldemar.', 'Não cadastra pedidos — isso é na tela de Pedidos.'],
    quemVe: 'Quem tem a permissão Fluxo de Caixa; as parcelas exibidas dependem das empresas liberadas em Pedidos.',
    dados: 'Pedidos → parcelas.',
    tour: [
  ...
  pedidos: {
    ...
    dicas: ['Quem lança vê o previsto; quem confere lança o real <b>sem ver o previsto</b> — a diferença aparece na Conciliação.', 'Pode deixar parcela em branco e completar depois.', 'As parcelas dos pedidos que chegaram alimentam o Fluxo de Caixa (Contas a Pagar).'],
  ...
  fechamento: {
    titulo: 'Fechamento do Mês', versao: 1,
    resumo: 'Aprove e <b>trave</b> cada mês por operação. Mês travado não aceita mais edição nos Lançamentos. Tudo fica registrado em log, com o motivo quando o mês é reaberto.',
    passos: [
    ...
    dicas: ['<b>Aprovado</b> ainda permite editar; só <b>Travado</b> bloqueia.', 'A aba Histórico traz também a trilha de quem alterou cada Lançamento.', 'A matriz dos últimos 12 meses dá a visão geral — clique num mês para abri-lo.'],
