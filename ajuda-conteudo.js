...
window.SAFI_AJUDA = { telas: {
  ...
  lancamentos: {
    ...
    passos: [
      ...
      { t: 'Salve', d: '<b>Salvar Lançamentos</b> grava <b>apenas as células que você mudou</b> (elas ficam com borda âmbar até salvar). O DRE é atualizado sozinho e a alteração fica na trilha de auditoria.' },
    ],
