...
window.SAFI_AJUDA = { telas: {
  ...
  fluxocaixa: {
    ...
    dicas: ['O total a pagar e quantos pedidos estão com a previsão de chegada vencida aparecem acima da tabela.', 'Pedido com previsão de chegada anterior a hoje aparece em vermelho.'],
